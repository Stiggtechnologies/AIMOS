...
export type ModuleKey = 'command_center' | 'operations' | 'clinical' | 'revenue' | 'growth' | 'intelligence' | 'strategy' | 'workforce' | 'supply_chain' | 'admin' | 'patient_experience' | 'aim_automation';
