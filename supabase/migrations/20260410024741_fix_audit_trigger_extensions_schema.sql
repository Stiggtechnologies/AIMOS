/*
  # Fix Audit Trigger Function - Use extensions Schema for pgcrypto

  pgcrypto is installed in the 'extensions' schema (not 'pgcrypto').
  This corrects the search path and digest() call so the trigger fires correctly.
*/
